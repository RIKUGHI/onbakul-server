<?php
  ...
  class OutletsModel extends CI_Model{
    ...
    public function getOutlets($idOwner, $q, $firstData, $limit) {
      return $this->db->where("id_owner = '$idOwner' AND outlet_name LIKE '%$q%'")->order_by('outlet_name', 'ASC')->get('outlets', $limit, $firstData);
    }
